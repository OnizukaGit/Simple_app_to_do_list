...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/kamil/Pulpit/ZADANIA_REKRUTACYJNE/BACK/2.1'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/kamil/Pulpit/ZADANIA_REKRUTACYJNE/BACK/2.1/bin/deactivate.nu'
